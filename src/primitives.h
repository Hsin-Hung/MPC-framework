...
/*******************************************************************
* or: Computes the logical OR between two predicates x, y
...
*      The following holds: P1_rnum + P2_rnum + P3_rnum = 0
*
*      P1 calls or() with input: x1, x2, y1, y2, P1_rnum
*      P2 calls or() with input: x2, x3, y2, y3, P2_rnum
*      P3 calls or() with input: x3, x1, y3, y1, P3_rnum
*
*      Does NOT require Beaver triples or all-to-all communication
*      BUT requires pseudo-random sharing of zero
* *****************************************************************/
...
/*******************************************************************
 * not: Computes the complement of a boolean share x
 *      Result: NOT x
 *      Does not require party-to-party communication
 * *****************************************************************/
BShare not(BShare x);
...
/*******************************************************************
 * xor: Computes the logical XOR between two boolean shares x, y
 *      Result: x ^ y
 *      Does not require party-to-party communication
 * *****************************************************************/
...
*         - rows: the rows (contents) of the shares table
